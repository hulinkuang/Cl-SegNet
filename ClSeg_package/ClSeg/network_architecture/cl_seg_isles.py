...
from ClSeg.network_architecture.aff import Circle
...
class Generic_UNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        scale_factor = [(1, 0.5, 0.5), (1, 0.5, 0.5), (1, 0.5, 0.5), (1, 0.5, 0.5)]
        self.trans_encoder = Coformer3D(patch_size=(1, 2, 2), scale_factor=scale_factor,
        ...
        for d in range(num_pool):
            ...
            # if d in (4, 5):
            #     self.fuse.append(SE_Fusion(output_features))
            # add convolutions
