...
from ClSeg.network_architecture.cl_seg_isles import Generic_UNet
...
class nnUNetTrainerV2_ISLES(nnUNetTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            self.print_to_log_file(f"initial lr: {self.initial_lr}")
    ...
    def do_split(self):
        ...
        if not isfile(join(self.dataset_directory, "splits_isles.pkl")):
            shutil.copy('../../../data/splits_isles.pkl', self.dataset_directory)

        splits_file = join(self.dataset_directory, "splits_isles.pkl")
    ...
    def setup_DA_params(self):
        ...
        self.downsampe_scales = self.net_num_pool_op_kernel_sizes
