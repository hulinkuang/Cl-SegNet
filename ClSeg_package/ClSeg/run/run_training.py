...
from ClSeg.run.default_configuration import get_default_configuration
...
def main():
    ...
    parser.add_argument("-network_trainer", type=str, default='nnUNetTrainerV2_AISD',
                        help='nnUNetTrainerV2_AISD for AISD dataset, nnUNetTrainerV2_ISLES for ISLES 2018 dataset')
    parser.add_argument("-task", type=str, default='666', help="can be task name or task id")
    parser.add_argument("-fold", type=str, default='all', help='0, 1, ..., 5 or \'all\'')
    parser.add_argument("-outpath", type=str, default='Coformer_4', help='output path')
    ...
    trainer_class = get_default_configuration(outpath, network, task, network_trainer, plans_identifier, \
                                              search_in=(ClSeg.__path__[0], "training", "network_training"), \
                                              base_module='ClSeg.training.network_training')
